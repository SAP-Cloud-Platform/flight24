CLASS /dmo/cx_flight_legacy24 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_24',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_24',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id24 OPTIONAL
        booking_id            TYPE /dmo/booking_id24 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id24 OPTIONAL
        agency_id             TYPE /dmo/agency_id24 OPTIONAL
        customer_id           TYPE /dmo/customer_id24 OPTIONAL
        carrier_id            TYPE /dmo/carrier24-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_24-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_24-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date24 OPTIONAL
        end_date              TYPE /dmo/end_date24 OPTIONAL
        booking_date          TYPE /dmo/booking_date24 OPTIONAL
        flight_date           TYPE /dmo/flight_date24 OPTIONAL
        status                TYPE /dmo/travel_status24 OPTIONAL
        currency_code         TYPE /dmo/currency_code24 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id24,
          mv_booking_id            TYPE /dmo/booking_id24,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id24,
          mv_agency_id             TYPE /dmo/agency_id24,
          mv_customer_id           TYPE /dmo/customer_id24,
          mv_carrier_id            TYPE /dmo/carrier24-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_24-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_24-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date24,
          mv_end_date              TYPE /dmo/end_date24,
          mv_booking_date          TYPE /dmo/booking_date24,
          mv_flight_date           TYPE /dmo/flight_date24,
          mv_status                TYPE /dmo/travel_status24,
          mv_currency_code         TYPE /dmo/currency_code24,
...
CLASS /dmo/cx_flight_legacy24 IMPLEMENTATION.
