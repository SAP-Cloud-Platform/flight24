@AbapCatalog.sqlViewName: '/DMO/CURRHLP24'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Help View for Currency Conversion'
define view /DMO/CURRENCY_HELPER24
  with parameters
    amount             : /dmo/total_price24,
    source_currency    : /dmo/currency_code24,
    target_currency    : /dmo/currency_code24,
    exchange_rate_date : /dmo/booking_date24

  as select from /dmo/agency24
