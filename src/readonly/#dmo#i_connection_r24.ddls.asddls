@AbapCatalog.sqlViewName: '/DMO/ICONNE_R24'
...
define view /DMO/I_Connection_R24
  as select from /dmo/connecti_24 as Connection

  association [1..*] to /DMO/I_Flight_R24 as _Flight  on  $projection.AirlineID    = _Flight.AirlineID
                                                    and $projection.ConnectionID = _Flight.ConnectionID
  association [1]    to /DMO/I_Carrier24  as _Airline on  $projection.AirlineID = _Airline.AirlineID

{
  ...
  key   Connection.connection_id    as ConnectionID,
        ...
        @Consumption.valueHelpDefinition: [{  entity: {   name: '/DMO/I_Airport24',
                              element:    'AirportID' } }]
        @Search.defaultSearchElement: true
