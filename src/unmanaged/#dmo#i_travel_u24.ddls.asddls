@AbapCatalog.sqlViewName: '/DMO/ITRAV_U24'
...
define root view /DMO/I_Travel_U24
  as select from /dmo/travel24 as Travel -- the travel table is the data source for this view

  composition [0..*] of /DMO/I_Booking_U24 as _Booking

  association [0..1] to /DMO/I_Agency24       as _Agency    on $projection.AgencyID        = _Agency.AgencyID
  association [0..1] to /DMO/I_Customer24     as _Customer  on $projection.CustomerID      = _Customer.CustomerID
...

{
    ...
    @Consumption.valueHelpDefinition: [{ entity : {name: '/DMO/I_Agency24', element: 'AgencyID'  } }]
